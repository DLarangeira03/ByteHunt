...
namespace byte_hunt.Controllers
{
    public class UtilizadorController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,Tipo")] Utilizador utilizador)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nome,Tipo")] Utilizador utilizador)
        {
            if (id != utilizador.Id)
            {
                return NotFound();
